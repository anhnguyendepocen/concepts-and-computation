...
![`.csv` in a Text Editor](03-notes-computing-figures/csv-text-editor.png)
...
![`.dta` in a Text Editor](03-notes-computing-figures/dta-text-editor.png)
...
![`.csv` in Excel](03-notes-computing-figures/csv-excel.png)
...
![](03-notes-computing-figures/directory.png)
...
When you think you know, check your work by trying your commands. I put `cool-project` [on Github](https://github.com/pos5737/cool-project). Clone it and see if you can load the data sets.
...
1. Download the nominate data sets from the [data page](data.html) and put them in the `data/` subdirectory.
